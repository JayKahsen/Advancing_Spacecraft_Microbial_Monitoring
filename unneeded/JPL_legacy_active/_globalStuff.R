...
experiment_order='PPR'
location_order=c("PHSF Highbay floor","Field Control","PHSF Airlock floor")
  experiment_order='Clipper'
  
  vPrint(unique(meta$bar_name))
  bar_name_order=c('Cotton Device Control' ,'Macrofoam Device Control','Cotton Environmental Control','Macrofoam Environemental Control' ,'Cotton Dry + Metal','Macrofoam Dry + Metal','Cotton Wet + Metal','Macrofoam Wet + Metal' ,'Water Only','NTC')
...
order_vector=c(experiment_order,location_order,treatment_order)
...
palette_label <- c(   
  ...
  'Macrofoam Environemental Control'='Macrofoam Environemental Control',
  ...
  'Reagent Control'='Reagent Control',
  'reagent_control'='Reagent Control',
  '2.00E+2'='2.00E+2',
  '2.00E+3'='2.00E+3',
  '2.00E+4'='2.00E+4',
  '2.00E+5'='2.00E+5',
  '2.00E+6'='2.00E+6',
  'NTC'='NTC', 
  'magnetic_bead'='Automatic Magnetic Bead',
  ...
  'NA'='NTC',
  'spin_column'='Manual Spin Column',
  'magnetic_bead'='Automated Magnetic Beads',
...
print_palette_assignments <- function(vec) {
...
print_palette_assignments(order_vector)
...
palette_color=c(palette_color,
                ...
                'Macrofoam Environemental Control'=palette_color['Macrofoam'],
...
palette_size=c(
  ...
  'Macrofoam Environemental Control'=3,
  'Cotton Dry + Metal'=3,
...
theme_global <- function(base_size = 11) {
  theme_gray(base_size = base_size) +
    ...
    #  legend.position='bottom',
      ...
      legend.background = element_rect(fill = palette_color['general_background']),
      axis.title = element_markdown(size = (base_size + 2) * magnify, face = 'bold'),
      axis.text = element_markdown(size = base_size * magnify, face = 'bold',color='black'),
